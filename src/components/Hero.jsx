...
const Hero = () => {
    ...
    return (
        /* Note: no dvh/vh here. Height is controlled in CSS (#hero { min-height: var(--app-height) }) */
        <section id="hero" className="relative" ref={sectionRef}>
            {/* Video Background (fills the stable hero box) */}
            <video
                id="hero-video"
        ...
        "
            ...
            <div className="title-wrapper relative select-none">
                <h1 className="title outline-text" ref={titleRef}>
